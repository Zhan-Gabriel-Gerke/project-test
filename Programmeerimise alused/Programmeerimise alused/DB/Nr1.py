...
# finally:
#     if conn:
#         conn.close()  # Ühenduse sulgemine


# # Andmete lugemine
# try:
#     # filename=path.abspath(__file__)
#     # dbdir=filename.rstrip('9.1. Andmebaas Tkinteris (Ühendamine ja lugemine).py')
#     # dbpath=path.join(dbdir,'movies.db')
#     # conn = sqlite3.connect(dbpath)  
