...
def load_data_from_db(tree):
    ...
    conn = sqlite3.connect(r'C:\Users\zange\source\repos\Zhan-Gabriel-Gerke\project-test\Programmeerimise alused\Programmeerimise alused\DB\AppData\data.db')
    cursor = conn.cursor()
...
# Avab lisamise faili
def add_data():
    subprocess.run(["python", r"C:\Users\zange\source\repos\Zhan-Gabriel-Gerke\project-test\Programmeerimise alused\Programmeerimise alused\DB\Nr1.py"])
...
def add_data2():
    ...
    def insert_data():
        if validate_data():
            connection = sqlite3.connect(r"C:\Users\zange\source\repos\Zhan-Gabriel-Gerke\project-test\Programmeerimise alused\Programmeerimise alused\DB\AppData\data.db")
