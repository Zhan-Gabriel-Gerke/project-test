...
def before_start():
    ...
    #     global entry_email_var, entry_teema_var, entry_kiri_var
def erase_file():
    with open(r'C:\Users\LP1\source\repos\Zhan-Gabriel-Gerke\project-test\Programmeerimise alused\Programmeerimise alused\Grafika\on_exit.txt', 'w', encoding="utf-8") as eracefile:
        pass
def on_exit():
...
def eelvade():
    get_data_entry()
    info = f"""    Saatja: testmailfortthk@gmail.com
...
def ajalkiri():
    entry_kiri.insert("end", 'Teie lemmikõpilane ZHAN-GABRIEL GERKE.')
def write_to_db(entry_email_var, entry_teema_var, entry_kiri_var):
    with open(r'C:\Users\LP1\source\repos\Zhan-Gabriel-Gerke\project-test\Programmeerimise alused\Programmeerimise alused\Grafika\tipoDB.txt', "w", encoding="utf-8") as f:
