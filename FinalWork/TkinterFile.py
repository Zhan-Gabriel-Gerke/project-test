...
def WindowsTK():
    ...
    Button_back_login.place(x=700, y=550)
    Name_Lable = tk.Label(frame_create, text='Name', font=('Arial', 15, 'bold'), bg='gray')
    Name_Lable.place(x=100, y=200)
    Surname_Lable = tk.Label(frame_create, text='Surname', font=('Arial', 15, 'bold'), bg='gray')
    Surname_Lable.place(x=100, y=230)
    ...
    Name_Entry = tk.Entry(frame_create, bg='lightgray', font=('Arial',15,'bold'))
    Name_Entry.place(x=200, y=200)
    SurName_Entry = tk.Entry(frame_create, bg='lightgray', font=('Arial',15,'bold'))
    SurName_Entry.place(x=200, y=230)
    ...
    Email_LogIn_Label = tk.Label(frame_log_in, bg='gray', text='Email', font=('Arial', 15, 'bold'))
    Email_LogIn_Label.place(x=100, y=200)
    Email_LogIn_Entry = tk.Entry(frame_log_in, bg='lightgray', font=('Arial',15, 'bold'))
    Email_LogIn_Entry.place(x=220   , y=200)
    ...
    LogIn_Button = tk.Button(frame_log_in, bg='gray', font=('Arial', 15, 'bold'), text='Log In')
